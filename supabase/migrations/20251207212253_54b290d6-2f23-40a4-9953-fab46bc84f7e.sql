-- Update handle_new_user to allow admin-created users to bypass signup check
...
BEGIN
  ...
  is_admin_created := COALESCE((NEW.raw_app_meta_data->>'created_by_admin')::boolean, false);
