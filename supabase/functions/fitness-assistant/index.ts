...
- Πάντα ρώτα για: στόχο, επίπεδο εμπειρίας, διαθέσιμες μέρες, τυχόν τραυματισμούς πριν δώσεις πρόγραμμα
- Τα προγράμματα πρέπει να είναι ρεαλιστικά και ασφαλή
- Πρότεινε πάντα ζέσταμα και αποθεραπεία
- Στα πλάνα διατροφής, δώσε γεύματα με θερμίδες και μακροθρεπτικά
